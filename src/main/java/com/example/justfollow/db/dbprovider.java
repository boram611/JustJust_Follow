...
public class dbprovider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/"
            + dbContract.MemoEntry.TABLE_NAME);

    // 1개의 아이템 요청 MIME 타입
    public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.example.databaseexam.provider." + dbContract.MemoEntry.TABLE_NAME;
    ...
    static {
        // content://com.example.databaseexam.provider/memo
        sUriMatcher.addURI(AUTHORITY, dbContract.MemoEntry.TABLE_NAME, ALL);
        // content://com.example.databaseexam.provider/memo/1 (#은 모든 숫자와 대응)
        sUriMatcher.addURI(AUTHORITY, dbContract.MemoEntry.TABLE_NAME + "/#", ITEM);
    }

    private dbhelper mMemoDbHelper;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int deleteCount = db.delete(dbContract.MemoEntry.TABLE_NAME,
                selection,
                selectionArgs);
        ...
        switch (sUriMatcher.match(uri)) {
            case ALL:
                long id = mMemoDbHelper.getWritableDatabase()
                        .insert(dbContract.MemoEntry.TABLE_NAME, null, values);
                if (id > 0) {
    ...
    public boolean onCreate() {
        // 메모 DB 헬퍼의 인스턴스 초기화
        mMemoDbHelper = dbhelper.getInstance(getContext());
        return true;
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Cursor cursor = database.query(dbContract.MemoEntry.TABLE_NAME,
                projection,
                selection,
                selectionArgs,
                null,
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int update = db.update(dbContract.MemoEntry.TABLE_NAME,
                values,
                selection,
                selectionArgs);
