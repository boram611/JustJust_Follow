...
public class MapSearchDetailActivity extends AppCompatActivity {
    ...
    private void makeChart() {
        RadarDataSet dataSet = new RadarDataSet(dataValue(), "Ambient environment");
        dataSet.setColor(Color.BLUE);

        RadarData data = new RadarData();
        data.addDataSet(dataSet);
        String[] labels = {"large supermarket", "Convenience store", "School", "academy", "Subway", "Bank", "Hostpital", "Pharmacy", "Cafe"};
